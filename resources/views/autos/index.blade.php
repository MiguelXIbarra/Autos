    ...
    <div class="d-flex justify-content-between align-items-end mb-5">
        <div>
            ...
            <p class="text-white italic"
                ...
                Panel de <span style="color: #C9A24A; font-weight: 900; font-style: normal;">Autos</span>
            </p>
        </div>
        <div class="d-flex gap-3">
            <a href="{{ route('autos.create') }}" class="btn-lux">
                <i class="fas fa-car mr-2"></i> Nueva Unidad
            </a>
                ...
                <table id="luxureTable" class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-white font-weight-bold italic">{{ $item['unidad'] }}</td>
                            <td class="align-middle text-muted">{{ $item['anio'] }}</td>
                            <td class="align-middle text-[#C9A24A] font-weight-bold">{{ $item['precio'] }}</td>
                            <td class="text-center align-middle">
                                <div class="acciones-container">
                                    <a href="{{ route('autos.show', $item['id']) }}" class="icon-btn text-info"><i
                                            class="fas fa-eye"></i></a>
                                    <a href="{{ route('autos.edit', $item['id']) }}"
                                        class="icon-btn text-warning mx-2"><i class="fas fa-pen-nib"></i></a>
                                    <a href="{{ route('autos.destroy', $item['id']) }}" class="icon-btn text-danger"
                                        onclick="return confirm('¿Eliminar unidad?')"><i
