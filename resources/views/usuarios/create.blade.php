                ...
                <div class="card-body p-5">
                    <form action="{{ route('usuarios.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" class="form-control lux-input" required>
                        </div>
                        <div class="form-group mb-4">
                            <label class="text-[#C9A24A] uppercase tracking-widest font-bold mb-2"
                        ...
                        <div class="form-group mb-4">
                            <label class="text-[#C9A24A] uppercase tracking-widest font-bold mb-2"
                                style="font-size: 0.6rem; color: #C9A24A;">Contraseña</label>
                            <input type="password" name="password" class="form-control lux-input" required>
                        </div>
                        <div class="form-group mb-5">
                            <label class="text-[#C9A24A] uppercase tracking-widest font-bold mb-2"
                                style="font-size: 0.6rem; color: #C9A24A;">Confirmar Contraseña</label>
