    ...
    <div class="d-flex justify-content-between align-items-end mb-5">
        <div>
            ...
            <p class="text-white italic"
                ...
                Panel de <span style="color: #C9A24A; font-weight: 900; font-style: normal;">Clientes</span>
            </p>
        </div>
        <div class="d-flex gap-3">
            <a href="{{ route('clientes.create') }}" class="btn-lux">
                ...
                <table id="luxureTable" class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-[#C9A24A] font-weight-bold">{{ $item['telefono'] }}</td>
                            <td class="text-center align-middle">
                                <div class="acciones-container">
                                    <a href="{{ route('clientes.show', $item['id']) }}" class="icon-btn text-info"><i
                                            class="fas fa-eye"></i></a>
                                    <a href="{{ route('clientes.edit', $item['id']) }}"
                                        class="icon-btn text-warning mx-2"><i class="fas fa-pen-nib"></i></a>
                                    <a href="{{ route('clientes.destroy', $item['id']) }}" class="icon-btn text-danger"
                                        onclick="return confirm('¿Eliminar cliente?')"><i
